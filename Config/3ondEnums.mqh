//+------------------------------------------------------------------+
//|                                                3ondEnums.mqh       |
//|           TerzaOnda EA v1.7.2 — Enumerations & Structs          |
//|                                                                  |
//|  Enum FRAMEWORK (stabili, non cambiano con engine swap)          |
//|  Enum ENGINE (KPC — cambiano con engine swap)                    |
//|  + struct CycleRecord                                            |
//|  + costanti globali                                              |
//+------------------------------------------------------------------+
...
//|                                                                  |
//| 5 modalita' disponibili, le prime 3 basate sul canale engine:    |
//|                                                                  |
...
//+------------------------------------------------------------------+
//| === ENGINE-SPECIFIC ENUMS (KPC) ===                              |
//| Questi enum cambiano quando si swappa engine                     |
//+------------------------------------------------------------------+

//+------------------------------------------------------------------+
//| KPC TRIGGER MODE — Quando scatta il segnale                      |
//+------------------------------------------------------------------+
enum ENUM_TRIGGER_MODE_V2
{
   TRIGGER_INTRABAR  = 0,   // Intrabar (segnale immediato — repaints)
   TRIGGER_BAR_CLOSE = 1    // Bar Close (anti-repaint, raccomandato)
};

//+------------------------------------------------------------------+
//| KPC TF PRESET — Auto-preset per timeframe Keltner Channel        |
//+------------------------------------------------------------------+
