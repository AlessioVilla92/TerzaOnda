//+------------------------------------------------------------------+
//|                                         adKPCEngine.mqh          |
//|           AcquaDulza EA — KPC Engine Orchestrator                 |
//|                                                                  |
...
//|                                                                  |
//|  Calls sub-modules:                                              |
//|    adKPCPresets  — TF auto-preset                                |
//|    adKPCBands    — KAMA + KC band calculation                    |
//|    adKPCFilters  — 7 quality filters + squeeze/fire              |
//|    adKPCCooldown — SimpleCooldown                                |
//|    adKPCLTFEntry — LTF entry confirmation                        |
//+------------------------------------------------------------------+
